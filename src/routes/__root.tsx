...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Nexus Vault — Premium Access" },
      { name: "twitter:title", content: "Nexus Vault — Premium Access" },
      { property: "og:description", content: "Plataforma premium de gestión de licencias, reportes y seguimiento." },
      { name: "twitter:description", content: "Plataforma premium de gestión de licencias, reportes y seguimiento." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e30f6fbe-041c-4fb2-8551-941c0eb0bb1b/id-preview-218e547c--f8731362-6811-4776-a739-3b1e3113e745.lovable.app-1780443291959.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e30f6fbe-041c-4fb2-8551-941c0eb0bb1b/id-preview-218e547c--f8731362-6811-4776-a739-3b1e3113e745.lovable.app-1780443291959.png" },
